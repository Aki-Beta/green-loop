...
# Configuración (lee de variables de entorno; docker-compose.yml ya las define)
SECRET_KEY = os.getenv("SECRET_KEY", "greenloop-secret-key-change-in-production-please")
